...
export default function CardMovie(p: Item) {
    ...
    return (
        <div className="relative w-1/3 md:w-1/5 lg:w-1/6 p-1 lg:p-3  lg:hover:scale-110 duration-400">
            <div className="absolute flex justify-between w-full z-20 top-0 right-0 p-1 lg:p-4">
                ...
                <ButtomHeart name={p.name} poster_url={p.poster_url} slug={p.slug} thumb_url={p.thumb_url} />
            </div>
