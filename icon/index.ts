...
export const FilmIcon = lazy(() => import("./FilmIcon"))
export const WatchedIcon = lazy(() => import("./WatchedIcon"))
export const XcircleIcon = lazy(() => import("./XcircleIcon"))
export const BookIcon = lazy(() => import("./BookIcon"))